...
| Capability | <span class="text-purple-400">Mayor</span> | <span class="text-blue-400">Worker</span> | <span class="text-amber-400">Inspector</span> | <span class="text-green-400">Guard</span> | <span class="text-red-400">Envoy</span> |
|:-----------|:-----:|:------:|:---------:|:-----:|:-----:|
| Read code | ✅ | ✅ | ✅ | ✅ | ✅ |
| Edit files | ❌ | ✅ | ❌ | ❌ | ❌ |
| Local commits | ❌ | ✅ | ❌ | ❌ | ❌ |
